...
class User(BaseModel):
    ...
    merchantMaximumODAmount: Optional[Union[str, int , float]]
...
class Transaction(BaseModel):
    ...
    amount: Optional[Union[str, int, float]]
    previousBalance: Optional[Union[str, int, float]]
    currentBalance: Optional[Union[str, int, float]]
...
class JSONData(BaseModel):
    userID: Optional[Union[str, int]]
    balance: Optional[Union[str, int, float]]
